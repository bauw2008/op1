...
function checkProcess() {
    return fs.exec('/bin/pidof', ['vsftpd']).then(function(res) {
        return {
            running: res.code === 0,
...
function renderStatus(isRunning) {
    ...
    return String.format(
        ...
        color, icon, _('vsftpd'), statusText
    );
}
...
return L.view.extend({
	...
	populateServiceSettings: function(tab, _s, data) {
		...
		o = s.option(form.Value, 'pasv_min_port', _('Pasv Min Port'));
		o.datatype = 'uinteger';
		o.default = '50000';

		o = s.option(form.Value, 'pasv_max_port', _('Pasv Max Port'));
		o.datatype = 'uinteger';
		o.default = '51000';
	...
	populateGlobalSettings: function(tab, _s, data) {
		...
		o = s.option(form.Value, 'umask',
			_('File mode umask'),
			_('Uploaded file mode will be 666 - &lt;umask&gt;; directory mode will be 777 - &lt;umask&gt;.'));
		o.default = '022';
	...
	populateConnectionSettings: function(tab, _s, data) {
		...
		o = s.option(form.Value, 'maxrate',
			_('Max transmit rate'),
			_('in KB/s, 0 means no limitation'));
		o.datatype = 'uinteger';
		o.default = '0';
	...
	populateLogSettings: function(tab, _s, data) {
		...
		o.value('file',     _('Log file'));
		o.value('syslog',   _('Enable syslog'));
		o.default = 'file';
    ...
    _('Manage FTP access and server behavior through this configuration page.') +
    ' <a href="https://github.com/bauw2008/op1/tree/main/luci-app-vsftpd-js" target="_blank">' + _('GitHub') + '</a>');
