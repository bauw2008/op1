...
return view.extend({
  ...
  render: function (data) {
    ...
    const m = new form.Map('socat', _('SOCAT'),
      _('SOCAT is a powerful and flexible networking tool that allows you to forward, bridge, and transform data across various protocols. It serves as a versatile solution for network diagnostics, port forwarding, and creating complex network connections, with support for encryption and more.') +
    ' <a href="https://github.com/bauw2008/op1/tree/main/luci-app-socat-js" target="_blank">' + _('github') + '</a>');
